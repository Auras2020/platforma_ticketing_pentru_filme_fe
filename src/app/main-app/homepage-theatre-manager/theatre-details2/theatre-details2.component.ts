...
@Component({
  selector: 'app-theatre-details2',
  templateUrl: './theatre-details2.component.html',
  styleUrls: ['./theatre-details2.component.css']
})
export class TheatreDetails2Component implements OnInit{
  ...
  navigateToVenueSeatsPage(id: any): any{
    this.router.navigate(['theatre-manager', 'theatres', 'venue', id]);
  }
